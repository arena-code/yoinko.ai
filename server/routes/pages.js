// server/routes/pages.js — Filesystem-backed pages API
...
router.post('/', (req, res) => {
  try {
    ...
    let parentRelPath = '';
    if (parent_id) {
      try { parentRelPath = fromId(parent_id); } catch {}
    }
...
router.put('/:id', (req, res) => {
  try {
    ...
    if (name !== undefined) {
      // Rename: keep the file extension for pages
      ...
      return res.json({ page: page || { id: newId, path: newRelPath, name } });
    }
