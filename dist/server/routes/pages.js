...
import { deletePageShare, deletePageSharesForIds, getAssetShare, getPageShare, hashSharePassword, shareInfoFromRecord, updatePageSharePathPrefix, updatePageShareReference, upsertPageShare, } from '../share-service.js';
    ...
    try {
        ...
        if (name !== undefined) {
            ...
            if (!existingFileType) {
                ...
                updatePageShareReference(shareDb, pid, req.params.id, newId, newRelPath);
            }
            const flat = flattenTree(scanDir(pagesDir));
